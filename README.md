...
Este curso introduce a estudiantes de secundaria a la creación de sitios web sencillos con HTML y CSS.

El contenido está diseñado para ser claro, visual e interactivo, utilizando ejemplos prácticos y herramientas 100% en línea.
...
- Archivos base (`starter-files`)
- Ejemplos completos (`completed-examples`)
- Scripts del curso (`scripts`)
...
- 💻 **Práctica**: [Abrir en CodePen](https://codepen.io/pen/?template=your-starter) 🚀 **¡No necesitas registrarte!**
...
### 📗 Lección 7: Consejos, errores comunes y próximos pasos (5 minutos)
...
- **Consejos clave**:
  ...
  - Error común: olvidar cerrar etiquetas como `</p>` o `</div>`.
- 💻 **Comparte tu trabajo**: [Envía tu creación](https://forms.gle/your-form) 📤 **¡Guarda y comparte!**
...
|  2  | Huaman Gallardo, Bruno Aldair       | U202117762 |
|  3  | Melgarejo Quiroz, Josep Eliu        | U202315165 |
|  4  | Raymundo Villarroel, Nadhim Abigail | U202318001 |
|  5  | Sanchez Silva, Luciana Celeste      | U202215979 |

---

## ⭐ Nota final

Este curso ha sido diseñado para introducir a los estudiantes en el mundo de la programación de forma amigable, práctica y progresiva, utilizando herramientas accesibles y ejemplos reales.
